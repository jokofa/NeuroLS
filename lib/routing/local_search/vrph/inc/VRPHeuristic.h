...
// KITCHEN_SINK is not used in custom interface,
// we overwrite it here with the value of TABU
// to have enough precision for the custom rules
#define KITCHEN_SINK                            (1<<20) //(1<<28)

//custom rules
#define PERTURB_LI                              (1<<28)
#define PERTURB_OSMAN                           (1<<29)
#define PERTURB_TARGET                          (1<<30)
